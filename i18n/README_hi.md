...
[English](https://github.com/laurentvv/free-llm-api-keys-python) | [中文](README_zh.md) | **हिंदी** | [Español](README_es.md) | [Français](README_fr.md) | [العربية](README_ar.md) | [বাংলা](README_bn.md) | [Русский](README_ru.md) | [Português](README_pt.md) | [Bahasa Indonesia](README_id.md)
...
यह पैकेज अभी PyPI पर प्रकाशित नहीं हुआ है। आप इसे सीधे GitHub से इंस्टॉल कर सकते हैं।

### `uv` का उपयोग (अनुशंसित)
